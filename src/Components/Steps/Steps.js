      ...
      <div className="steps--container">
        <div className="steps--left">
          <img
            ...
            src={`${process.env.PUBLIC_URL}/img/htf-platform-image-2-1.png`}
          />
        ...
        <div className="steps--right">
          <div className="steps--right-group">
            ...
            <img
              ...
              src={`${process.env.PUBLIC_URL}/img/iconamoon-lightning-1-fill.svg`}
            />
          ...
          <div className="steps--right-group">
            ...
            <img
              className="img"
              alt="Mdi briefcase"
              src={`${process.env.PUBLIC_URL}/img/mdi-briefcase.svg`}
            />
            <p className="steps--right-text">
          ...
          <div className="steps--right-group">
            ...
            <img
              className="img"
              alt="Uis chart"
              src={`${process.env.PUBLIC_URL}/img/uis-chart.svg`}
            />
            <p className="steps--right-text">
